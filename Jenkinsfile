    ...
    stages {
        ...
        stage('Git main'){
            ...
            steps{
                ...
                checkout([$class: 'GitSCM', branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'GitHub-Actions', url: 'https://github.com/hariharan-k21/Jenkins-Multistage-CICD.git']]])
